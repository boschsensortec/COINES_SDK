...
LIBUSBP_API void libusbp_string_free(char *);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_error_copy(const libusbp_error *);

/*! Frees a returned error object.  Passing the NULL pointer to this function is
 * OK.  Do not free the same non-NULL error twice. */
LIBUSBP_API void libusbp_error_free(libusbp_error *);
...
LIBUSBP_API void libusbp_async_in_pipe_close(libusbp_async_in_pipe *);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_async_in_pipe_allocate_transfers(libusbp_async_in_pipe *,
                                                                                         size_t transfer_count,
                                                                                         size_t transfer_size);

/*! Starts reading data from the pipe. */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_async_in_pipe_start_endless_transfers(libusbp_async_in_pipe *);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_async_in_pipe_handle_events(libusbp_async_in_pipe *);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error *libusbp_async_in_pipe_has_pending_transfers(libusbp_async_in_pipe *,
                                                                                           bool * result);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error *libusbp_async_in_pipe_handle_finished_transfer(libusbp_async_in_pipe *,
                                                                                              bool * finished,
                                                                                              void * buffer,
                                                                                              size_t * transferred,
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_async_in_pipe_cancel_transfers(libusbp_async_in_pipe *);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_list_connected_devices(libusbp_device *** device_list,
                                                                               size_t * device_count);

/*! Frees a device list returned by libusbp_list_connected_device(). */
LIBUSBP_API void libusbp_list_free(libusbp_device ** list);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_find_device_with_vid_pid(uint16_t vendor_id,
                                                                                 uint16_t product_id,
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_copy(const libusbp_device * source,
                                                                    libusbp_device ** dest);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_get_vendor_id(const libusbp_device *,
                                                                             uint16_t * vendor_id);

/*! Gets the USB product ID of the device (idProduct). */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_get_product_id(const libusbp_device *,
                                                                              uint16_t * product_id);

/*! Gets the USB revision code of the device (bcdDevice). */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_get_revision(const libusbp_device *,
                                                                            uint16_t * revision);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_get_serial_number(const libusbp_device *,
                                                                                 char ** serial_number);
 ...
 * </pre>
 */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_device_get_os_id(const libusbp_device *, char ** id);
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_interface_create(const libusbp_device *,
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_interface_copy(const libusbp_generic_interface * source,
 ...
 * </pre>
 */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_interface_get_os_id(const libusbp_generic_interface *,
                                                                                    char ** id);
 ...
 * </pre>
 */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_interface_get_os_filename(
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_handle_open(const libusbp_generic_interface *,
                                                                            libusbp_generic_handle **);
 ...
 * closing the handle. */
LIBUSBP_API void libusbp_generic_handle_close(libusbp_generic_handle *);
...
LIBUSBP_API libusbp_error * libusbp_generic_handle_open_async_in_pipe(libusbp_generic_handle *,
                                                                      uint8_t pipe_id,
 ...
 * transfers. */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_generic_handle_set_timeout(libusbp_generic_handle *,
                                                                                   uint8_t pipe_id,
                                                                                   uint32_t timeout);
 ...
 */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_control_transfer(libusbp_generic_handle *,
...
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_write_pipe(libusbp_generic_handle *,
                                                                   uint8_t pipe_id,
                                                                   const void * buffer,
                                                                   size_t size,
                                                                   size_t * transferred);
 ...
 * The @a transferred parameter is an optional pointer to a variable that will
 * receive the number of bytes transferred. */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_read_pipe(libusbp_generic_handle *,
                                                                  uint8_t pipe_id,
                                                                  void * buffer,
                                                                  size_t size,
                                                                  size_t * transferred);
 ...
 * has not been closed. */
LIBUSBP_API int libusbp_generic_handle_get_fd(libusbp_generic_handle *);
...
LIBUSBP_API HANDLE libusbp_generic_handle_get_winusb_handle(libusbp_generic_handle *);
...
LIBUSBP_API void ** libusbp_generic_handle_get_cf_plug_in(libusbp_generic_handle *);
 ...
 *
 * The returned object must be freed with libusbp_generic_interface_free(). */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_serial_port_create(const libusbp_device *,
                                                                           uint8_t interface_number,
                                                                           bool composite,
                                                                           libusbp_serial_port **);
...
/*! Makes a copy of the generic interface object.  The copy must be freed with
 *  libusbp_generic_interface_free(). */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_serial_port_copy(const libusbp_serial_port * source,
 ...
 * You should free the returned string by calling libusbp_string_free().
 */
LIBUSBP_API LIBUSBP_WARN_UNUSED libusbp_error * libusbp_serial_port_get_name(const libusbp_serial_port *, char ** name);
