...
dfu-util --device -,108c:ab39 -a FLASH -D coines_bridge/coines_bridge_flash_firmware.bin -R
...
$APP_SWITCH_PATH/app_switch usb_dfu_bl
dfu-util --device -,108c:ab39 -a RAM -D bootloader_update/usb_ble_dfu_bootloader.pkg -R
...
$APP_SWITCH_PATH/app_switch usb_dfu_bl
dfu-util --device -,108c:ab39 -a RAM -D mtp_fw_update/usb_mtp.pkg -R
